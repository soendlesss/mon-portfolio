<template>
    <footer>
        ...
        <div class="icones-reseaux">
            <!-- GitHub -->
            <a href="https://github.com/soendlesss" target="_blank" aria-label="GitHub">
            ...
            <!-- LinkedIn -->
            <a href="https://www.linkedin.com/in/ethan-langlois-b3a2711bb/" target="_blank" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
<style scoped>
/* Les styles du footer sont dans style.css global */
</style>